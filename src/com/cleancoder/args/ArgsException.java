...
public class ArgsException extends Exception {
  ...
  private String errorArguID = null;
  ...
  public ArgsException(ErrorCode errorCode, String errorArgumentId, String errorParameter) {
    this.errorCode = errorCode;
    this.errorParameter = errorParameter;
    this.errorArguID = errorArgumentId;
  }
  ...
  public String errorMessage() {
    switch (errorCode) {
      ...
      case UNEXPECTED_STRING_ARGUMENT:
        return String.format("Unexpected String Argument %s", errorArguID);
    }
    return "";
  }
